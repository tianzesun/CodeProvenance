...
from src.evaluation.comparison_engine import (
    ToolMetrics,
...
from src.evaluation.benchmark_tribunal import BenchmarkTribunal, TribunalResult
from src.engines.execution.execution_engine import (
    ExecutionResult,
    DeterministicEnv,
)
from src.engines.execution.adapter_layer import (
    ToolFinding,
    MossAdapter,
    JPlagAdapter,
    AdapterRegistry,
