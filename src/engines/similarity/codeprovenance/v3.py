...
class CodeProvenanceV3(BaseCodeProvenanceEngine):
    ...
    def _ast_similarity(self, code_a: str, code_b: str, lang_a: str, lang_b: str) -> float:
        """Calculate AST-based structural similarity (from v2)."""
        try:
            from src.core.ir.ast_ir import ASTIR
    ...
    def _graph_similarity(self, code_a: str, code_b: str, lang_a: str, lang_b: str) -> float:
        """Calculate graph-based structural similarity."""
        try:
            from src.core.ir.graph_ir import GraphIR
