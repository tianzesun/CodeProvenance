...
class TokenHeatmapEngine:
    ...
    def build_heatmap(
        ...
        spans_a, spans_b = self._matches_to_spans(code_a, code_b, matches or [])
        ...
        if self.enable_ast_extraction:
            ...
            ast_spans_b = self._extract_ast_match_spans_code_b(
    ...
    def build_heatmap_for_single(
        ...
        for span_data in spans:
            ...
            token_span = TokenSpan(
                ...
                matched_value=span_data.get(
                    "text", code[span_data.get("start", 0) : span_data.get("end", 0)]
                ),
            ...
            if "a_start_offset" in match and "a_end_offset" in match:
                spans_a.append(
                    TokenSpan(
                        ...
                        match_type=match_type,
                        matched_value=code_a[
                            match["a_start_offset"] : match["a_end_offset"]
                        ],
                ...
                spans_b.append(
                    TokenSpan(
                        ...
                        confidence=confidence,
                        match_type=match_type,
                        matched_value=code_b[
                            match["b_start_offset"] : match["b_end_offset"]
                        ],
                        explanation=match.get("explanation", ""),
                    )
                )
