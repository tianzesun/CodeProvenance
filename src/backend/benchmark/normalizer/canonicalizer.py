...
Usage:
    from src.backend.benchmark.normalization.canonicalizer import Canonicalizer
...
class CanonicalComparePipeline:
    ...
    Usage:
        ...
        from src.backend.benchmark.normalization.canonicalizer import CanonicalComparePipeline
