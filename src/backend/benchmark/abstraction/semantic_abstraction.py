...
Usage:
    from src.backend.benchmark.abstraction.semantic_abstraction import SemanticAbstractor
...
class SemanticComparePipeline:
    ...
    Usage:
        ...
        from src.backend.benchmark.abstraction.semantic_abstraction import (
