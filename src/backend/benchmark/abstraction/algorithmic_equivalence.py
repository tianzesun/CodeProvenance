...
Usage:
    from src.backend.benchmark.abstraction.algorithmic_equivalence import AlgorithmicEquivalenceDetector
...
class AlgorithmicComparePipeline:
    ...
    Usage:
        from src.backend.benchmark.similarity.engines import HybridEngine
        from src.backend.benchmark.abstraction.algorithmic_equivalence import AlgorithmicComparePipeline
