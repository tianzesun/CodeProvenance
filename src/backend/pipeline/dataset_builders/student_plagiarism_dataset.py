...
""",
    ...
    # ---- Type-3 with mixed obfuscation ----
    {
        ...
        "code1": FIB_ASSIGNMENT["iterative_original"],
        "code2": _FIB_OBF.get(
            "iterative_original_obf_rename", FIB_ASSIGNMENT["iterative_v2"]
        ),
        "label": 1,
        "clone_type": 3,
        "obfuscation_level": 2,
    ...
    },
    {
        ...
        "code1": FIB_ASSIGNMENT["iterative_original"],
        "code2": _FIB_OBF.get(
            "iterative_original_obf_mixed", FIB_ASSIGNMENT["iterative_v2"]
        ),
        "label": 1,
        "clone_type": 3,
        "obfuscation_level": 4,
...
def save_manual_dataset(
    output_path: Path = Path("benchmark/data/manual_dataset.json"),
) -> None:
...
class KaggleStudentCodeDataset:
    ...
    def load_pairs(self, max_pairs: int | None = None) -> list[dict[str, Any]]:
        """
