...
from src.backend.evalforge.pipelines.runner import Experiment, run_standard_benchmark
...
def main():
    ...
    parser.add_argument(
        "--detectors", type=str, nargs="+", help="Detectors to benchmark"
    )
    parser.add_argument(
    ...
    if args.transformations:
        ...
        logger.info(
            f"Running robustness experiment with transformations: {args.transformations}"
        )
