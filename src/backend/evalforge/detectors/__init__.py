...
class IntegrityDeskAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        ...
        try:
            ...
            return DetectionResult(
                score=0.0, confidence=0.0, metadata={"error": str(e)}
            )
...
class JPlagAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        ...
        try:
            ...
            return DetectionResult(
                score=score, confidence=0.75, metadata={"engine": "jplag"}
            )
        except Exception as e:
            return DetectionResult(
                score=0.0, confidence=0.0, metadata={"error": str(e)}
...
class DolosAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        ...
        try:
            ...
            return DetectionResult(
                score=score, confidence=0.65, metadata={"engine": "dolos"}
            )
        except Exception as e:
            return DetectionResult(
                score=0.0, confidence=0.0, metadata={"error": str(e)}
...
class NiCadAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        ...
        try:
            ...
            return DetectionResult(
                score=score, confidence=0.6, metadata={"engine": "nicad"}
            )
        except Exception as e:
            return DetectionResult(
                score=0.0, confidence=0.0, metadata={"error": str(e)}
...
class PMDCPDAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        ...
        try:
            ...
            return DetectionResult(
                score=score, confidence=0.55, metadata={"engine": "pmd"}
            )
        except Exception as e:
            return DetectionResult(
                score=0.0, confidence=0.0, metadata={"error": str(e)}
