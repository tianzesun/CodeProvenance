...
class ThresholdConfig:
    ...
    @staticmethod
    def from_dict(d):
        return ThresholdConfig(**d)


class PRPoint:
    def __init__(self, t, p, r, f):
        self.threshold, self.precision, self.recall, self.f1 = t, p, r, f
...
class ThresholdOptimizer:
    ...
    def optimize_dual_threshold(
        self, scores, labels, high_r=(0.7, 0.95), low_r=(0.5, 0.8)
    ):
...
class FeedbackLoopPipeline:
    ...
    def run(self, scores, labels, weights, strategy="max_f1"):
        ...
        with open(f"{self.output_dir}/{version}.json", "w") as f:
