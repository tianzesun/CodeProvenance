...
# WeasyPrint 60 doesn't support: gap, grid, place-items, user-select, box-shadow
# Use flexbox with margins instead
_BASE_CSS = (
    ...
    ".chips{display:flex;flex-wrap:wrap;margin-left:auto}"
    ".chip{display:inline-flex;flex-direction:column;align-items:center;"
    "background:#fff;border:1px solid #e2e8f0;border-radius:8px;padding:8px 14px;min-width:72px;margin-right:10px}"
    ...
    "color:#94a3b8;display:flex;justify-content:space-between;flex-wrap:wrap}"
    "@media print{"
    "body{background:#fff}"
...
def _submission_card(entry: Dict[str, Any]) -> str:
    ...
    for line_info in annotated[:30]:
        ...
        code_rows += (
            ...
            "padding:1px 8px;font-size:11px;vertical-align:top'>"
            + str(ln_num)
            + "</td>"
            "<td style='color:"
            + text_color
    ...
    return (
        ...
        + ";color:"
        + badge_fg
        + ";border-radius:999px;padding:3px 10px;font-size:11px;font-weight:800;margin-right:8px'>"
        + status
        + "</span>"
        + (
...
def build_ai_originality_report_html(job: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "border-radius:10px;display:flex;align-items:center;justify-content:center;font-weight:900;"
        "font-size:16px;border:1.5px solid rgba(255,255,255,.25);margin-right:14px'>ID</div>"
        "<div>"
        ...
        + "</div>"
        "</div></div>"
        "<div style='text-align:right;font-size:11px;color:rgba(255,255,255,.80);line-height:1.7;margin-top:10px'>"
        ...
        "border-radius:0 6px 6px 0;font-size:12px;color:#334155;flex:1;min-width:200px;margin-right:10px;margin-bottom:10px'>"
        ...
        "</div>"
        "<div style='border-left:3px solid #2563eb;background:#f8fafc;padding:10px 12px;"
        "border-radius:0 6px 6px 0;font-size:12px;color:#334155;flex:1;min-width:200px;margin-bottom:10px'>"
        "<strong style='display:block;color:#0f172a;margin-bottom:3px'>"
