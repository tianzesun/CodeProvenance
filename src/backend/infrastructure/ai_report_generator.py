...
def build_ai_originality_report_html(job: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "<title>IntegrityDesk AI Detector Report \u2014 " + assignment + "</title>"
        ...
        "<button onclick='window.print()' style='display:inline-flex;align-items:center;"
        "gap:6px;padding:8px 16px;border-radius:7px;font-size:12px;font-weight:700;"
        "cursor:pointer;border:1.5px solid rgba(255,255,255,.30);"
