...
class LTIService:
    ...
    def handle_deep_linking(
        self, request: FastAPIRequest, selection_data: list[dict[str, Any]]
    ):
    ...
    def pass_grade(
        self, request: FastAPIRequest, score: float, comment: str | None = None
    ):
    ...
    def handle_plagiarism_callback(
        self, request: FastAPIRequest, submission_id: str, results: dict[str, Any]
    ):
