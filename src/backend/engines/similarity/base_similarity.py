...
class SimilarityEngine:
    ...
    def compare(
        ...
        result = {
            ...
            "confidence_interval": {"lower": lower, "upper": upper, "confidence": 0.95},
        }
        ...
        if self._deep_analysis_enabled:
            try:
                ...
                result["deep_analysis"] = {
                    ...
                    "tree_kernel_similarity": deep_result.get(
                        "tree_kernel_similarity", 0.0
                    ),
                    "normalized_ast_similarity": deep_result.get(
                        "normalized_ast_similarity", 0.0
                    ),
                    "cfg_similarity": deep_result.get("cfg_similarity", 0.0),
                    "clone_score": deep_result.get("clone_detection", {}).get(
                        "clone_score", 0.0
                    ),
                    "is_suspicious": deep_result.get("clone_detection", {}).get(
                        "is_suspicious", False
                    ),
                }
