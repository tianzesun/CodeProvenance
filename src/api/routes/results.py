...
from src.models.database import SimilarityResult
from src.utils.database import SimilarityResultService
from src.api.schemas import result as result_schema
