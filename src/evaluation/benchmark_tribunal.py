...
Usage:
    from src.evaluation.benchmark_tribunal import BenchmarkTribunal
...
from src.evaluation.dataset.ground_truth import (
    GroundTruthPair,
    EvaluationProtocol,
    DEFAULT_PROTOCOL,
    load_ground_truth,
...
from src.evaluation.comparison_engine import rank_tools, ToolRanking
from src.evaluation.ieee_report_generator import (
    BenchmarkReport,
...
class BenchmarkTribunal:
    ...
    def _run_external_tool(self, tool: str) -> List[Dict[str, Any]]:
        ...
        from src.engines.execution import ExecutionEngine, adapt_tool_output
