...
from src.evalforge.pipelines.runner import run_standard_benchmark, Experiment
from src.evalforge.reporting.generator import generate_standard_report
from src.evalforge.core.dataset import get_available_datasets
...
def main():
    ...
    if args.transformations:
        ...
        from src.evalforge.detectors import get_detector
        from src.evalforge.core.dataset import Dataset
