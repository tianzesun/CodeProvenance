...
from src.evalforge.core import BaseDetector, CodePair, BenchmarkResult
from src.evalforge.core.dataset import Dataset
from src.evalforge.core.metrics import compute_metrics
...
def run_standard_benchmark(dataset_name: str, detectors: Optional[List[str]] = None) -> BenchmarkRunner:
    ...
    from src.evalforge.detectors import get_detector, get_all_detectors
