...
from src.evalforge.core import BaseDetector, DetectionResult
...
class MOSSAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        from src.benchmark.competitors.moss import run_moss_approx
...
class JPlagAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        from src.benchmark.competitors.jplag import run_jplag_approx
...
class DolosAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        from src.benchmark.competitors.dolos import run_dolos_approx
...
class NiCadAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        from src.benchmark.competitors.nicad import run_nicad_approx
...
class PMDCPDAdapter(BaseDetector):
    ...
    def score(self, code_a: str, code_b: str) -> DetectionResult:
        from src.benchmark.competitors.pmd import run_pmd_approx
