...
class JobExecutor:
    ...
    def execute(job: Dict[str, Any]) -> Dict[str, Any]:
        ...
        from src.benchmark.datasets.loader import DatasetLoader
        from src.benchmark.transforms.engine import TransformEngine
        from src.benchmark.tool_runner import ToolRunner
